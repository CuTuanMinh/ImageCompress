...
class Example(Frame):
	...
	def initUI(self):
		...
		lbl0=Label(self,text="Xin gửi lời cảm ơn đến thầy Nguyễn Linh Giang đã giúp đỡ chúng em hoàn thành đề tài này")
